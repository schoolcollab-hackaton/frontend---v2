...
export default function AcademicSupport() {
  ...
  return (
    <div className="academic-support-container">
      {/* Enhanced Navbar */}
      <nav className="academic-support-navbar">
        <div className="navbar-content">
          <div className="navbar-left">
            ...
            <div className="page-title">
              ...
              <p>Découvrez les demandes d'aide et partagez vos connaissances</p>
            </div>
          </div>
          <div className="navbar-right">
            <div className="user-stats">
              ...
              <div className="stat">
                <span className="stat-number">
                  {requests.filter((r) => r.statut === "Completed").length}
                </span>
                ...
                <div className="requester-info">
                  <div className="requester-avatar">
                    {request.demandeur_avatar ? (
                      <img
                        src={request.demandeur_avatar}
                        alt={request.demandeur_name}
                      />
                    ) : (
                      <div className="avatar-placeholder">
                        {request.demandeur_name
                          .split(" ")
                          .map((n) => n[0])
                          .join("")}
                      </div>
                  ...
                  <div className="requester-details">
                    <div className="requester-name">
                      Demandé par: {request.demandeur_name}
                    </div>
                    {request.helper_name && (
                      <div className="helper-name">
                        Aidé par: {request.helper_name}
                      </div>
                    )}
                  </div>
                </div>
              ...
              <div className="request-actions">
                ...
                >
                  {expandedRequest === request.id
                    ...
                    : `Voir les commentaires (${request.comments.length})`}
                </button>
              </div>
                    ...
                    <div className="add-comment">
                      <div className="comment-form">
                        ...
                        <button
                          ...
                          disabled={
                            !commentText[request.id]?.trim() ||
                            commentLoading === request.id
                          }
